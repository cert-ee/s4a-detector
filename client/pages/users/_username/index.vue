              ...
              <v-tabs-content id="roles">
                <v-card>
                  ...
                  <v-card-title class="mb-3">
                    <v-layout row wrap>
                      <v-flex xs6>
                        <v-text-field append-icon="search" label="Search" single-line hide-details v-model="search" clearable></v-text-field>
                      </v-flex>
                    </v-layout>
                  </v-card-title>
                  <v-card-text>
              ...
              <v-tabs-content id="logs">
                <v-card>
                  <v-card-title class="mb-3">
                    <v-layout row wrap>
                      <v-flex xs6>
                        <v-text-field append-icon="search" label="Search" single-line hide-details v-model="logSearch" clearable></v-text-field>
                      </v-flex>
                    </v-layout>
                  </v-card-title>
                  <v-card-text>
